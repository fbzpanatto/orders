...
const getProducts = async (page) => {
    ...
    try {
        ...
        const rows = await (0, queries_1.selectAllFrom)(connection, tables_1.Tables.products, page);
...
const getProduct = async (req) => {
    ...
    try {
        connection = await (0, db_1.dbConn)();
        const queryResult = await (0, queries_1.selectAllWithWhere)(connection, tables_1.Tables.products, {});
...
const createProduct = async (body) => {
    ...
    try {
        connection = await (0, db_1.dbConn)();
        const queryResult = await (0, queries_1.insertInto)(connection, tables_1.Tables.products, body, []);
...
const updateProduct = async (id, req) => {
    ...
    try {
        ...
        const queryResult = await (0, queries_1.updateTableSetWhere)(connection, tables_1.Tables.products, 'id', id, req.body, []);
